...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-primary dark:bg-charcoal text-secondary border-t border-slate/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Content Links */}
          <div>
            <h3 className="text-secondary font-semibold mb-4">Content</h3>
        ...
        <div className="border-t border-slate/20 mt-8 pt-8 text-center">
          <p className="text-slate">
            © {currentYear} PRWRITES. All rights reserved. Made with ❤️ by PRWRITES Team.
          </p>
        </div>
      </div>
    </footer>
