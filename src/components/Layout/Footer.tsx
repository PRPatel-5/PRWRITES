...
const footerLinks = {
  ...
  { 
    name: 'LinkedIn', 
    href: 'https://www.linkedin.com/in/pr-writes-356363394/', 
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  { 
    name: 'Instagram', 
    href: 'https://www.instagram.com/pr_writes33?igsh=MWZieHh3aWdtbmJucA==', 
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  { 
    name: 'YouTube', 
    href: 'https://www.youtube.com/@PRWRITES', 
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  { 
    name: 'Facebook', 
    href: 'https://www.facebook.com/share/1AHTnxF1xz/', 
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm text-slate-400">
              ...
              <span>•</span>
              <Link href="cookie-policy" className="hover:text-gold-400 transition-colors">
                Cookies
              </Link>
            </div>

            <p className="text-slate-400 text-sm">
              Made with <span className="text-gold-500">♥</span> by PRWRITES's Owener
            </p>
          </div>
        </div>
      </div>
