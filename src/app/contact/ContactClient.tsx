              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">prwrites33@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">JUST MAIL ME ON EMAIL</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-semibold text-navy-600 dark:text-slate-200">No Office</p>
                    <p className="text-slate-600 dark:text-slate-400">Freelancer From SURAT</p>
                  </div>
                </div>
              </div>
            </div>
